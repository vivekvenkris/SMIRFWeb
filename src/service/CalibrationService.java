...
public class CalibrationService {
	...
	public boolean Calibrate(String utc) throws IOException, InterruptedException{
			System.err.println("Starting calibration for UTC:" + utc);
			String process = "cd "+BackendConstants.resultsDir+"/"+utc+ "; "+ BackendConstants.calibrateScript;
			...
			process = "cd "+BackendConstants.resultsDir+"/"+utc+ "; "+BackendConstants.updateDelays;
			System.err.println("running: "+ process);
