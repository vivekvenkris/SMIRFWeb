...
import util.SFtpFile;

public class ProcessMonitorService implements PolledDirectory{
    private String host;
    private String workingDirectory;
    private String username;
    private String password;

    public ProcessMonitorService(String host, String workingDirectory) {
        this.host = host;
        this.workingDirectory = workingDirectory;
        this.username = "mpsr";
        this.password = "DMapdsar$4";
