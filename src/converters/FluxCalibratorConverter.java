...
@FacesConverter("converters.FluxCalibratorConverter")
public class FluxCalibratorConverter implements Converter{
	@Override
	public Object getAsObject(FacesContext fc, UIComponent uic, String str) {
		if(str.equals("auto")){
			...
			return (Object)DBManager.getFluxCalibratorByName(str);
		}
	}
